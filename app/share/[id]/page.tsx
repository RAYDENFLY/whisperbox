...
import { DownloadShareImage } from "@/components/share/download-share-image"
...
export default async function SharePage({ params }: { params: { id: string } }) {
    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-zinc-950 p-4 flex items-center justify-center">
            <div className="w-full max-w-md">
                <DownloadShareImage fileName={`whisperbox-${message.id}.png`}>
                    {/* 9:16 Card Container */}
